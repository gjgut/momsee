package com.example.android0211.Refactor.Service;
...
import com.example.android0211.Refactor.Activity.Parent.parentChildList;
import com.google.firebase.messaging.FirebaseMessagingService;
import com.google.firebase.messaging.RemoteMessage;

public class msFCMService extends FirebaseMessagingService {
    private static final String TAG = msFCMService.class.getSimpleName();
    @Override
    ...
    private void sendNotification(String messageBody) {
        Intent intent = new Intent(this, parentChildList.class);
